<?php
namespace NIMIUS\LocationManager\Evaluation;
...
/**
 * Bounded decimal field evaluation class.
 *
 * Formats to have a fixed number of decimals as well as a minimum
 * and maximum value.
 */
abstract class BoundedDecimalFieldEvaluation implements EvaluationInterface
{
    ...
    public function returnFieldJS()
    {
        ...
        return str_replace(array_keys($replace), array_values($replace), $this->fieldJs);
    }
    ...
    protected function evaluate($value)
    {
        ...
        return number_format($bounded, $this->decimals);
    }
}
